...
func main() {
	...
	//1.创建Pods
	podInfo, err := clientset.CoreV1().Pods(nameSpace).Create(context.TODO(), pod, metav1.CreateOptions{})
	if err != nil {
	...
	//2.监听Pod
	watch, err := clientset.CoreV1().Pods(nameSpace).Watch(context.TODO(), metav1.ListOptions{Watch: true})
	if err != nil {
